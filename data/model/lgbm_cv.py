...
with codecs.open('../input//train_df.pkl', 'r', 'utf-8', 'ignore') as f:
    train_df = pd.read_csv(f)

with codecs.open('../input/test_df.pkl', 'r', 'utf-8', 'ignore') as f:
    test_df = pd.read_csv(f)

remove_features = pd.read_pickle('../features/remove_features.pkl')
...
if not LOCAL_TEST:
    ...
    test_predictions[['TransactionID','isFraud']].to_csv('../submit/lgbm_cv.csv', index=False)
