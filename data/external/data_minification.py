...
print('Load Data')
train_df = pd.read_csv('../data/input/train_transaction.csv')
test_df = pd.read_csv('../data/input/test_transaction.csv')
test_df['isFraud'] = 0

train_identity = pd.read_csv('../data/input/train_identity.csv')
test_identity = pd.read_csv('../data/input/test_identity.csv')
...
train_df.to_pickle('../data/input/train_transaction.pkl')
test_df.to_pickle('../data/input/test_transaction.pkl')

train_identity.to_pickle('../data/input/train_identity.pkl')
test_identity.to_pickle('../data/input/test_identity.pkl')
