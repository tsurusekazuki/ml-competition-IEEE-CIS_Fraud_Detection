...
print('Load Data')
train_df = pd.read_pickle('../data/input/train_transaction.pkl')
...
if LOCAL_TEST:
    ...
    train_identity = pd.read_pickle('../data/input/train_identity.pkl')
    ...
    test_df = pd.read_pickle('../data/input/test_transaction.pkl')
    train_identity = pd.read_pickle('../data/input/train_identity.pkl')
    test_identity = pd.read_pickle('../data/input/test_identity.pkl')
...
# output
train_df.to_pickle('../data/input/train_df.pkl')
test_df.to_pickle('../data/input/test_df.pkl')

remove_features = pd.DataFrame(remove_features, columns=['features_to_remove'])
remove_features.to_pickle('../data/features/remove_features.pkl')